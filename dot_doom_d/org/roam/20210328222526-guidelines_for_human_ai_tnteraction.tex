...
\begin{frame}[label={sec:org3d912a7}]{Motivation}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3d05a84}]{Phase 1: Consolidation of guidelines}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdb2e651}]{Phase 2: Modified Heuristic Evaluation}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5a6c7fe}]{Phase 3: User study}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga5b42a6}]{Phase 3: User study}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgabbd089}]{Phase 3: User study}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgee2538f}]{Phase 3: User Study (Results)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org71985a3}]{Phase 3: User Study (Results)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga78ea19}]{Phase 4: Expert Evaluation}
\begin{itemize}
...
\begin{frame}[label={sec:orgf4085e9}]{Discussion}
...
\begin{frame}[label={sec:org3aef844}]{Some guidelines}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org096bb46}]{Some guidelines}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org32ff1d0}]{Some guidelines}
...
\begin{frame}[label={sec:org7ca9b19}]{Some guidelines}
